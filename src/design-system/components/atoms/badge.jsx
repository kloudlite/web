...
export const Badge = ({ type, label, icon }) => {
  let Icon = icon
  return (
    <div className={cn("flex gap-md items-center  h-3xl py-sm px-lg w-fit rounded-full bodySm border select-none", {
      "border-border-default bg-surface-basic-default text-text-default": type === "neutral",
