import { ArrowDown, ArrowUp, GearFill, HamburgerFill, Info, InfoFill, Search } from "@jengaicons/react";
...
const OptionListHook = ({ isIconButton }) => {
  ...
  return <OptionList open={open} onOpenChange={setOpen}>
    {!isIconButton && <OptionList.Trigger>
      <ButtonGroup.Button content={"menu"} variant={"basic"} selected={open} />
    </OptionList.Trigger>}
    {isIconButton && <OptionList.Trigger>
      <ButtonGroup.IconButton icon={HamburgerFill} variant={"basic"} selected={open} />
    </OptionList.Trigger>}
    <OptionList.Content >
