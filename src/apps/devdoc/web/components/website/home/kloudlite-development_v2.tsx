...
const KDElement = ({
  ...
  return (
    <div
      ref={ref}
      className={cn('wb-flex wb-flex-row kd-item')}
      data-index={index}
    >
      <div
        className={cn(
    ...
    <GraphExtended>
      <div className="wb-relative wb-grid wb-grid-cols-1 lg:wb-grid-cols-[384px_auto] 2xl:wb-grid-cols-[448px_auto] 3xl:wb-grid-cols-[512px_auto] wb-items-start">
        ...
        <GraphItem
          lines={{ bottom: false }}
          className={cn(
            'wb-bg-surface-basic-subdued wb-p-3xl md:wb-p-5xl wb-sticky wb-z-50 wb-top-[68px]',
          )}
        >
        ...
        <ResponsiveContainer>
          <GraphItem className="wb-bg-surface-basic-subdued wb-flex wb-flex-row">
            <div ref={ref} className="wb-flex wb-flex-col wb-overflow-hidden">
              {consts.homeNew.kloudliteDevelopmentData.map((kd, index) => {
                return (
                  <KDElement
                    ...
                    isLastItem={
                      index ===
                      consts.homeNew.kloudliteDevelopmentData.length - 1
                    }
                  />
                );
              })}
