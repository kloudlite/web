  ...
  return (
    <GraphExtended>
      <div className="relative wb-grid wb-grid-cols-1 lg:wb-grid-cols-[384px_auto] 2xl:wb-grid-cols-[448px_auto] 3xl:wb-grid-cols-[512px_auto] wb-items-start">
        ...
        <GraphItem className="wb-bg-surface-basic-subdued dark:wb-bg-surface-darktheme-basic-subdued wb-flex wb-flex-row xl:wb-pb-3xl 2xl:wb-pb-xl 3xl:wb-pb-[24px]">
