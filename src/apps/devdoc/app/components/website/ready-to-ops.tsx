  ...
  return (
    <Graph className="-mx-10xl my-5xl xl:!py-8xl">
      <div className="px-10xl">
        <GraphItem>
          <div className="px-3xl pt-5xl pb-5xl md:!px-10xl md:!py-7xl lg:!px-10xl lg:!py-7xl flex flex-col gap-6xl items-center bg-surface-basic-subdued md:min-h-[288px] md:max-h-[288px]">
