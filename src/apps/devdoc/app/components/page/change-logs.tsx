  ...
  return (
    <div className="wb-flex wb-flex-row wb-gap-3xl">
      ...
      <div className="wb-flex wb-flex-col wb-items-center wb-gap-md wb-pb-md">
        <div className="wb-rounded-full wb-w-3xl wb-h-3xl wb-p-md wb-flex wb-items-center wb-justify-center wb-bg-surface-basic-pressed dark:wb-bg-surface-darktheme-basic-pressed wb-text-icon-disabled dark:wb-text-icon-darktheme-disabled ">
          <GitCommit size={12} />
        </div>
        <div className="wb-bg-border-dark dark:wb-bg-border-darktheme-dark wb-w-[1px] wb-opacity-70 wb-flex-1" />
      </div>
      <div className="wb-flex wb-flex-col wb-gap-3xl wb-pb-5xl">
        <div className="wb-sticky wb-top-0 wb-bg-surface-basic-subdued dark:wb-bg-surface-darktheme-basic-subdued md:wb-hidden wb-headingMd wb-text-text-default dark:wb-text-text-darktheme-default">
          Apr 23, 2024
        </div>
        <div className="wb-text-text-default dark:wb-text-text-darktheme-default wb-bodyLg">
    ...
    <div>
      <Wrapper className="wb-relative wb-flex wb-py-6xl md:wb-py-8xl lg:wb-py-10xl">
        <div className="xl:wb-px-5xl 2xl:wb-px-8xl 3xl:wb-px-10xl wb-flex wb-flex-col wb-gap-xl">
          ...
          <p className="wb-bodyLg lg:wb-bodyXl wb-text-text-soft dark:wb-text-text-darktheme-soft">
