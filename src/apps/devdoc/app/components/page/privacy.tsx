      ...
      <div className="max-w-[1440px] m-auto px-3xl md:!px-8xl lg:!px-11xl xl:!px-13xl 2xl:!px-14xl pb-6xl md:!pb-8xl xl:!pb-10xl">
        ...
        <div>
          ...
          <div className="bodyLg text-text-strong flex flex-col gap-4xl pt-4xl">
            ...
            <p>
              <ul className="list-disc pl-5xl flex flex-col gap-xl">
                <li>
            ...
            <p>
              <ul className="list-disc pl-5xl flex flex-col gap-xl">
                <li>Create a user account (individual or corporate);</li>
                <li>Make online purchases or register products;</li>
            ...
            <p>Kloudlite may use personal data we collect about you to:</p>
            <p>
              <ul className="list-disc pl-5xl flex flex-col gap-xl">
                <li>
