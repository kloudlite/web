...
# Config & Secrets
You can access Congifs & Secrets in your apps and workspaces. Using these, you can configure environment variables, and create config files mounted 
...
## Secrets
Secrets in Kloudlite are similar to configs but are used to store sensitive information securely. These include credentials, 
tokens, passwords, and other confidential data that should not be exposed.
