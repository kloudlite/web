...
To get started with Kloudlite, create a team in Kloudlite dashboard. The team is where you manage your 
environments, managed services, infrastructure and devices.

{/* Video of creation of teams */}
...
kl auth login
```
This will open a browser window to authenticate your account. Once authenticated, you will be able to access your Kloudlite account from the CLI.

***Note:** You will be prompted to select the team you want to work with. you can change the team using `kl use team` command.*
