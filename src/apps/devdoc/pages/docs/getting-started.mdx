...
Login and set up your free account.
...
<VideoPlayer src="/docs/introduction/setup-env.mp4"/>
...
<VideoPlayer src="/docs/introduction/setup-kl.mp4"/>
...
You will be prompted to select kloudlite account and the default environment this workspace will connect to. 
...
> **Note:** The running container is already connected to the environment using wireguard. And also service disvovery 
