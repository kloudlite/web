...
export const SubList = ({ children }) => {
  return <ul className="wb-list-[circle] wb-pl-3xl">{children.props.children}</ul>;
};

<div className="wb-bg-surface-basic-subdued dark:wb-bg-surface-darktheme-basic-subdued">
    <div className="wb-max-w-[1440px] wb-m-auto wb-px-3xl md:wb-px-8xl lg:wb-px-11xl xl:wb-px-13xl 2xl:wb-px-14xl wb-pb-6xl md:wb-pb-8xl xl:wb-pb-10xl">
        <h1 className="wb-heading4xl-marketing md:wb-heading5xl-marketing lg:wb-heading6xl-marketing wb-text-text-default dark:wb-text-text-darktheme-default wb-py-6xl md:wb-py-8xl xl:wb-py-10xl">
          Privacy Policy 
        </h1>
        <div>
          <div className="wb-text-text-soft dark:wb-text-text-darktheme-soft wb-bodyLg">
            Last updated: <span className="wb-headingMd wb-text-text-default dark:wb-text-text-darktheme-default">12th Dec, 2023</span>
          </div>
