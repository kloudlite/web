...
import NodePoolImg from '../public/nodepool-simple-to-use.svg';
import FlexibleImage from '../public/flexible-illustration.svg';
import CostIllustration from '../public/cost-illustration.svg';
import {
  successStories,
