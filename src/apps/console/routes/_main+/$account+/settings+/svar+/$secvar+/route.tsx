...
import { ISecretVariable } from '~/console/server/gql/queries/secret-variables-queries';
...
const ConfigBody = ({ secret }: { secret: ISecretVariable }) => {
    ...
    <>
      <Wrapper
        header={{
          ...
          backurl: `/${account}/settings/secrets-variables`,
