  ...
  useDebounce(
    () => {
      (async () => {
        try {
          const resp = await axios({
            url: `${observeUrl}/observability/metrics/cpu?cluster_name=${clusterName}&tracking_id=${app.id}`,
            method: 'GET',
      ...
      (async () => {
        try {
          const resp = await axios({
            url: `${observeUrl}/observability/metrics/memory?cluster_name=${clusterName}&tracking_id=${app.id}`,
            method: 'GET',
            withCredentials: true,
          });
